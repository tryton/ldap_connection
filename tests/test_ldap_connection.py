...
def suite():
    return unittest.TestLoader().loadTestsFromTestCase(LDAPConnectionTestCase)

if __name__ == '__main__':
    suiteTrytond = trytond.tests.test_tryton.suite()
    suiteLDAPConnection = suite()
    alltests = unittest.TestSuite([suiteTrytond, suiteLDAPConnection])
